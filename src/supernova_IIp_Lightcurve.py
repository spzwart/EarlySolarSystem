...
#    L = numpy.log10(L.value_in(units.erg/units.s))    
#    LII = numpy.log10(LII.value_in(units.LSun))
#    LIb = numpy.log10(LIb.value_in(units.LSun))
#    Laof = numpy.log10(Laof.value_in(units.LSun))
    L10a = numpy.log10(L10a.value_in(units.erg/units.s))
    L12bku = numpy.log10(L12bku.value_in(units.erg/units.s))
    LIb = numpy.log10(LIb.value_in(units.erg/units.s))
    Laof = numpy.log10(Laof.value_in(units.erg/units.s))
