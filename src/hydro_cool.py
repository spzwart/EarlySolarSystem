...
class Hydro:
    def __init__(self, hydro_code, particles, impact_shell=Particles(0), converter=None, dt=1|units.hour, Sun=Particles(0)):
        ...
        self.box_size = 0.1|units.parsec
        ...
        self.attributes=["x", "y", "z", "vx", "vy", "vz", "mass", "u", "rho", "h_smooth", "pressure", "du_dt"]
